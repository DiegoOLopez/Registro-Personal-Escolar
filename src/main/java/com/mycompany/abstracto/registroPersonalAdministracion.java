 ...
 * @author cer
 */
public class registroPersonalAdministracion extends javax.swing.JFrame {

    /**
     * Creates new form registroPersonalAdministracion
     */
    public registroPersonalAdministracion() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel140.setText("Registro Personal Administrativo");
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        // TODO add your handling code here:
        personalAdministracion rAdministrativo = new personalAdministracion ();
        rAdministrativo.getNombre();
        rAdministrativo.getApellidoP();
        rAdministrativo.getApellidoM();
        rAdministrativo.getSexo();
        rAdministrativo.getDia();
        rAdministrativo.getMes();
        rAdministrativo.getAño();
        rAdministrativo.getEstado();

        rAdministrativo.getCargo();
        rAdministrativo.getAdministracion();

        rAdministrativo.getSalario();
        rAdministrativo.getHorasTrabajo();
        rAdministrativo.getDiasTrabajo();
        rAdministrativo.getDiasVacaciones();
        
        CURP.setText(rAdministrativo.getApellidoP().substring(0, 2) + rAdministrativo.getApellidoM().substring(0, 1) + rAdministrativo.getNombre().substring(0, 1) + rAdministrativo.getAño().substring(2, 4) + rAdministrativo.getMes() + rAdministrativo.getDia() + rAdministrativo.getApellidoP().substring(2,3)+ rAdministrativo.getApellidoM().substring(2,3)+ rAdministrativo.getNombre().substring(1,2));
        RFC.setText(rAdministrativo.getApellidoP().substring(0, 2) + rAdministrativo.getApellidoM().substring(0, 1) + rAdministrativo.getNombre().substring(0, 1) + rAdministrativo.getAño().substring(2, 4) + rAdministrativo.getMes() + rAdministrativo.getDia());

        try {
            BufferedWriter bw = new BufferedWriter(new FileWriter("Previsualizacion registro personal administrativo.txt"));
            ...
            bw.write("---------------DATOS DOCENTE PREVISUALIZACION---------------\n"+
                ...
                "\nCargo: " + cargo.getText() +
                "\nProfesion del administrativo: " + administracion.getText() +
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(registroPersonalAdministracion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new registroPersonalAdministracion().setVisible(true);
            }
        });
    }

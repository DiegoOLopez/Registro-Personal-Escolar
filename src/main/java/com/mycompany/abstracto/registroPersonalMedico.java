...
public class registroPersonalMedico extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel145.setText("Especialidad:");
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel10Layout.createSequentialGroup()
                        .addGroup(jPanel10Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(jPanel10Layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addComponent(RFC, javax.swing.GroupLayout.PREFERRED_SIZE, 176, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(jPanel10Layout.createSequentialGroup()
                                .addComponent(jLabel1)
                                .addGap(18, 18, 18)
                                .addComponent(CURP, javax.swing.GroupLayout.PREFERRED_SIZE, 176, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addGap(101, 101, 101))))
        );
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        // TODO add your handling code here:
        personalMedico rMedico = new personalMedico();
        rMedico.getNombre();
        rMedico.getApellidoP();
        rMedico.getApellidoM();
        rMedico.getSexo();
        rMedico.getDia();
        rMedico.getMes();
        rMedico.getAño();
        ...
        rMedico.getEspecialidad();
        rMedico.getProfesion();

        rMedico.getSalario();
        rMedico.getHorasTrabajo();
        rMedico.getDiasTrabajo();
        rMedico.getDiasVacaciones();
        
        CURP.setText(rMedico.getApellidoP().substring(0, 2) + rMedico.getApellidoM().substring(0, 1) + rMedico.getNombre().substring(0, 1) + rMedico.getAño().substring(2, 4) + rMedico.getMes() + rMedico.getDia() + rMedico.getApellidoP().substring(2,3)+ rMedico.getApellidoM().substring(2,3)+ rMedico.getNombre().substring(1,2));
        RFC.setText(rMedico.getApellidoP().substring(0, 2) + rMedico.getApellidoM().substring(0, 1) + rMedico.getNombre().substring(0, 1) + rMedico.getAño().substring(2, 4) + rMedico.getMes() + rMedico.getDia());
